...
import com.siasun.musicvideo.utils.file.FileSaveUtils;
...
public class FileMusicUtils {
    ...
    public static String getFileName(String artist, String title) {
        ...
        if (TextUtils.isEmpty(artist)) {
            artist = BaseApplication.getInstance().getString(R.string.unknown);
        }
        if (TextUtils.isEmpty(title)) {
            title = BaseApplication.getInstance().getString(R.string.unknown);
        }
        return artist + " - " + title;
    }
