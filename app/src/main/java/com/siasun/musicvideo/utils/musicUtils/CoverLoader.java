...
import com.siasun.musicvideo.utils.ScreenUtils;
...
public class CoverLoader {
    ...
    private Bitmap getDefaultCover(Type type) {
        switch (type) {
            case BLUR:
                return BitmapFactory.decodeResource(BaseApplication.getInstance().getResources(), R.mipmap.default_cover);
            case ROUND:
                Bitmap bitmap = BitmapFactory.decodeResource(BaseApplication.getInstance().getResources(), R.mipmap.default_cover);
