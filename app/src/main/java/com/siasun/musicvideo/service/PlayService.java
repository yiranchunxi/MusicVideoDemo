...
import com.siasun.musicvideo.inter.callback.EventCallback;
import com.siasun.musicvideo.inter.callback.OnPlayerEventListener;
import com.siasun.musicvideo.manager.AudioFocusManager;
import com.siasun.musicvideo.manager.MediaSessionManager;
import com.siasun.musicvideo.model.action.MusicPlayAction;
import com.siasun.musicvideo.model.bean.AudioBean;
import com.siasun.musicvideo.model.enums.PlayModeEnum;
import com.siasun.musicvideo.receiver.AudioBroadcastReceiver;
import com.siasun.musicvideo.receiver.AudioEarPhoneReceiver;
import com.siasun.musicvideo.utils.SPUtils;
import com.siasun.musicvideo.utils.app.QuitTimer;
import com.siasun.musicvideo.utils.musicUtils.NotificationUtils;
import com.siasun.musicvideo.utils.scan.FileMusicScanManager;
...
public class PlayService extends Service {
        ...
        if (intent != null && intent.getAction() != null) {
            switch (intent.getAction()) {
                ...
                case Constant.LOCK_SCREEN_ACTION:
                    ...
                    Log.e("PlayService","PlayService"+"---LOCK_SCREEN"+mIsLocked);
                    break;
                //当屏幕灭了，添加锁屏页面
                case Intent.ACTION_SCREEN_OFF:
                    startLockAudioActivity();
                    Log.e("PlayService","PlayService"+"---当屏幕灭了");
                    break;
                case Intent.ACTION_SCREEN_ON:
                    Log.e("PlayService","PlayService"+"---当屏幕亮了");
                    break;
                default:
                    break;
            }
    ...
    public void next() {
        ...
        switch (mode) {
            ...
            default:
                ...
                Log.e("PlayService","PlayService"+"----mPlayingPosition----"+ mPlayingPosition);
                play(mPlayingPosition);
                break;
        }
    }
    ...
    private void updatePlayProgressShow() {
        ...
        Log.e("PlayService","updatePlayProgressShow");
    ...
    public void updatePlayingPosition() {
        ...
        for (int i = 0; i < audioMusics.size(); i++) {
            ...
            Log.e("PlayService","PlayService"+"----musicId----"+ musicId);
